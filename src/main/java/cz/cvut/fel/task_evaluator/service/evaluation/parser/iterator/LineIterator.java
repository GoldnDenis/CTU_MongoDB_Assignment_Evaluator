package cz.cvut.fel.task_evaluator.service.evaluation.parser.iterator;

import cz.cvut.fel.task_evaluator.utility.StringPatternChecker;
...
public class LineIterator implements Iterator<Character> {
    ...
    public boolean startsWithStringConstruct() {
        return StringPatternChecker.isStringConstruct(text.substring(currentColumnIndex));
    }
