...
public class AggregateProjectAddFieldsStageCriterion extends AssignmentCriterion {
    public AggregateProjectAddFieldsStageCriterion(InsertedDocumentStorage mockDb) {
        super(
                mockDb,
                Criteria.AGGREGATE_PROJECT_ADD_FIELDS_STAGE.getDescription(),
                Criteria.AGGREGATE_PROJECT_ADD_FIELDS_STAGE.getRequiredCount()
        );
    }
