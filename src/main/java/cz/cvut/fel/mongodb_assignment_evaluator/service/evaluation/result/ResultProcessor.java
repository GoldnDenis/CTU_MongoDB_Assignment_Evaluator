...
public class ResultProcessor {
    public static String formatToText(Set<CriterionEvaluationResult> criterionEvaluationResults) {
        StringBuilder text = new StringBuilder();
        int i = 0;
        for (CriterionEvaluationResult criterionEvaluationResult : criterionEvaluationResults) {
            i++;
            text.append(i)
                    .append(") ")
                    .append(criterionEvaluationResult.toString());
        }
...
//            text.append(i + 1)
//                    .append(") '")
//                    .append(criterionEvaluationResults.get(i).toString());
