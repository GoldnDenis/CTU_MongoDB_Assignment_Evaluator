...
public class AggregateMinMaxAggregatorCriterion extends AssignmentCriterion {
    public AggregateMinMaxAggregatorCriterion(InsertedDocumentStorage mockDb) {
        super(
                mockDb,
                Criteria.AGGREGATE_MIN_MAX_AGGREGATOR.getDescription(),
                Criteria.AGGREGATE_MIN_MAX_AGGREGATOR.getRequiredCount()
        );
    }
