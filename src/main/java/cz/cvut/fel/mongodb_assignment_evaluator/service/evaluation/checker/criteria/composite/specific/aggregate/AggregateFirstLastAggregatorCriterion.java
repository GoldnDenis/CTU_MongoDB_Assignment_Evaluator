...
public class AggregateFirstLastAggregatorCriterion extends AssignmentCriterion {
    public AggregateFirstLastAggregatorCriterion(InsertedDocumentStorage mockDb) {
        super(
                mockDb,
                Criteria.AGGREGATE_FIRST_LAST_AGGREGATOR.getDescription(),
                Criteria.AGGREGATE_FIRST_LAST_AGGREGATOR.getRequiredCount()
        );
    }
