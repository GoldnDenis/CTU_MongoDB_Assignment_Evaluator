...
public class AggregateMatchStageCriterion extends AssignmentCriterion {
    public AggregateMatchStageCriterion(InsertedDocumentStorage mockDb) {
        super(
                mockDb,
                Criteria.AGGREGATE_MATCH_STAGE.getDescription(),
                Criteria.AGGREGATE_MATCH_STAGE.getRequiredCount()
        );
    }
