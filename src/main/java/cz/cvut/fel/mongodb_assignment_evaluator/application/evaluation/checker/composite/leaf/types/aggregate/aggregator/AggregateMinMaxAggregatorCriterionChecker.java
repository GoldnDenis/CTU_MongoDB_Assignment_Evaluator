...
public class AggregateMinMaxAggregatorCriterionChecker extends CheckerLeaf<AggregateQuery> {
    public AggregateMinMaxAggregatorCriterionChecker(InsertedDocumentStorage documentStorage) {
