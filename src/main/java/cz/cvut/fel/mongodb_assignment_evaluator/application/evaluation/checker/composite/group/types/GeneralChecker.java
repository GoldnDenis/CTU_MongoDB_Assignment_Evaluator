...
import cz.cvut.fel.mongodb_assignment_evaluator.application.evaluation.checker.composite.leaf.types.general.CommentCriterionChecker;
...
public class GeneralChecker extends CriteriaGroupChecker<Query> {
    ...
    protected List<CheckerLeaf<Query>> initCriteria() {
        return List.of(
                new CommentCriterionChecker(documentStorage)
        );
    }
}
