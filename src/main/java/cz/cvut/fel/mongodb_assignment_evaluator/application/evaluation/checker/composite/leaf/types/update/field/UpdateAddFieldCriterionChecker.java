...
public class UpdateAddFieldCriterionChecker extends CheckerLeaf<UpdateQuery> {
    public UpdateAddFieldCriterionChecker(InsertedDocumentStorage documentStorage) {
