...
public class AggregateGroupStageCriterionChecker extends CheckerLeaf<AggregateQuery> {
    public AggregateGroupStageCriterionChecker(InsertedDocumentStorage documentStorage) {
