...
public class AggregateLimitStageCriterionChecker extends CheckerLeaf<AggregateQuery> {
    public AggregateLimitStageCriterionChecker(InsertedDocumentStorage documentStorage) {
