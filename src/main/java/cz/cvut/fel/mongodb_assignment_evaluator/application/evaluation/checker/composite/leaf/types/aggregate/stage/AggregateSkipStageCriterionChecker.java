...
public class AggregateSkipStageCriterionChecker extends CheckerLeaf<AggregateQuery> {
    public AggregateSkipStageCriterionChecker(InsertedDocumentStorage documentStorage) {
