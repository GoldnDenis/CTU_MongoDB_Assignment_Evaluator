...
public class AggregateMatchStageCriterionChecker extends CheckerLeaf<AggregateQuery> {
    public AggregateMatchStageCriterionChecker(InsertedDocumentStorage documentStorage) {
