...
public class AggregateLookupStageCriterionChecker extends CheckerLeaf<AggregateQuery> {
    public AggregateLookupStageCriterionChecker(InsertedDocumentStorage documentStorage) {
