...
public class UpdateArrayAddCriterionChecker extends CheckerLeaf<UpdateQuery> {
    public UpdateArrayAddCriterionChecker(InsertedDocumentStorage documentStorage) {
