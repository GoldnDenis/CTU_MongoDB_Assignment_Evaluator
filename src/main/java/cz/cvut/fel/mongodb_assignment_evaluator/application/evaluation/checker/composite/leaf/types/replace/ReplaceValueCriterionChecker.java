...
public class ReplaceValueCriterionChecker extends CheckerLeaf<ReplaceOneQuery> {
    public ReplaceValueCriterionChecker(InsertedDocumentStorage documentStorage) {
