...
import cz.cvut.fel.mongodb_assignment_evaluator.application.evaluation.checker.composite.leaf.types.replace.ReplaceValueCriterionChecker;
...
public class ReplaceOneGroupChecker extends CriteriaGroupChecker<ReplaceOneQuery> {
    ...
    protected List<CheckerLeaf<ReplaceOneQuery>> initCriteria() {
        return List.of(
                new ReplaceValueCriterionChecker(documentStorage)
        );
    }
}
