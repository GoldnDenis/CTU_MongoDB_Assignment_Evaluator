...
public class AggregateFirstLastAggregatorCriterionChecker extends CheckerLeaf<AggregateQuery> {
    public AggregateFirstLastAggregatorCriterionChecker(InsertedDocumentStorage documentStorage) {
