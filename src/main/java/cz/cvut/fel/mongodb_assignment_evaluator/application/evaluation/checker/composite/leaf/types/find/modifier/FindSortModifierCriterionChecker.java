...
public class FindSortModifierCriterionChecker extends CheckerLeaf<FindQuery> {
    public FindSortModifierCriterionChecker(InsertedDocumentStorage documentStorage) {
