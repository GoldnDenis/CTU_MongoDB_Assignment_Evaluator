...
public class AggregateSortStageCriterionChecker extends CheckerLeaf<AggregateQuery> {
    public AggregateSortStageCriterionChecker(InsertedDocumentStorage documentStorage) {
