...
public class FindLogicalOperatorCriterionChecker extends CheckerLeaf<FindQuery> {
    public FindLogicalOperatorCriterionChecker(InsertedDocumentStorage documentStorage) {
