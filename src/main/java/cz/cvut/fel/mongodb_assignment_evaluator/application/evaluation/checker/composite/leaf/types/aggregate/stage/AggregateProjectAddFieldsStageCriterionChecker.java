...
public class AggregateProjectAddFieldsStageCriterionChecker extends CheckerLeaf<AggregateQuery> {
    public AggregateProjectAddFieldsStageCriterionChecker(InsertedDocumentStorage documentStorage) {
