...
public class CriteriaFactory {
    public EvaluationCriterion<? extends QueryToken> createEvaluationCriterion(String name) {
        try {
            ...
            switch (criterion) {
                ...
                case CREATE_ONE_COLLECTION -> {
                    return new OperatorEvalCriterion<>(CreateCollectionQueryToken.class, priority, Operators.CREATE_COLLECTION);
                }
                // Insert criteria
                case INSERT_TEN_DOCUMENTS -> {
                    return new QuantityCriterion<>(InsertQueryToken.class, priority);
                }
                ...
                case INSERT_ONE_USED -> {
                    return new OperatorEvalCriterion<>(InsertQueryToken.class, priority, Operators.INSERT_ONE);
                }
                case INSERT_MANY_USED -> {
                    return new OperatorEvalCriterion<>(InsertQueryToken.class, priority, Operators.INSERT_MANY);
                }
                // Replace criteria
                case REPLACE_VALUE -> {
                    return new QuantityCriterion<>(ReplaceQueryToken.class, priority);
                }
                // Update criteria
                ...
                // Find criteria
                case FIND_FIVE -> {
                    return new QuantityCriterion<>(FindQueryToken.class, priority);
                }
                ...
                case SORT_MODIFIER -> {
                    return new ModifierOperatorCriterion<>(FindQueryToken.class, priority, Operators.SORT);
                }
                // Aggregate criteria
                case AGGREGATE_FIVE -> {
                    return new QuantityCriterion<>(AggregateQueryToken.class, priority);
                }
                case STAGE_MATCH -> {
